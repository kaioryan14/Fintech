...
class UsuarioTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('Permissao', ['foreignKey' => 'id_permissao']);
        $this->hasMany('investimento', ['foreignKey' => 'id_usuario']);
        $this->hasMany('grupo', ['foreignKey' => 'id_usuario', 'joinType' => 'INNER']);
    }
